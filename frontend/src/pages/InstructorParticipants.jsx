...
const InstructorParticipants = () => {
  ...
  return (
    <div style={containerStyles}>
      ...
      {/* Instructor Referral Info */}
      <Card style={{ marginBottom: '2rem', padding: '1.5rem', background: 'linear-gradient(135deg, rgba(251, 191, 36, 0.1) 0%, rgba(16, 185, 129, 0.1) 100%)', border: '2px solid rgba(251, 191, 36, 0.3)' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div>
            <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem', color: '#fbbf24' }}>Your Referral Information</h3>
            <p style={{ color: '#a0aec0', fontSize: '0.875rem' }}>Share your invite link to recruit members. All participants you create are automatically added under your referral.</p>
          </div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                ...
                <button
                  ...
                  style={{
                    padding: '0.75rem 1.5rem',
                    background: copiedLink ? '#10b981' : '#fbbf24',
                    color: copiedLink ? '#fff' : '#1a1a1a',
                    border: 'none',
                    borderRadius: '6px',
                    cursor: 'pointer',
                    fontWeight: '600',
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
              <div>
                <div style={{ fontSize: '0.875rem', color: '#a0aec0', marginBottom: '0.25rem' }}>Your Direct Referrals</div>
                <div style={{ fontSize: '1.75rem', fontWeight: '600', color: '#10b981' }}>
                  {user?.directRecruits || 0}
                </div>
              </div>
              <div>
                <div style={{ fontSize: '0.875rem', color: '#a0aec0', marginBottom: '0.25rem' }}>Total Network Size</div>
                <div style={{ fontSize: '1.75rem', fontWeight: '600', color: '#10b981' }}>
                  {user?.networkSize || 0}
                </div>
              </div>
              <div>
                <div style={{ fontSize: '0.875rem', color: '#a0aec0', marginBottom: '0.25rem' }}>Total Earned</div>
                <div style={{ fontSize: '1.75rem', fontWeight: '600', color: '#fbbf24' }}>
                  {formatCurrency(user?.totalEarned || 0)} USDT
                </div>
              </div>
            </div>
          </div>
