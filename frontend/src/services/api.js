...
export const adminAPI = {
  ...
  promoteParticipant: (id, rankId) => api.post(`/admin/participants/${id}/promote`, { rankId }),
  moveParticipant: (id, newReferrerId) => api.post(`/admin/participants/${id}/move`, { newReferrerId }),
  ...
  deductCoins: (data) => api.post('/instructor/deduct-coins', data),
